  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'bitcoin': '0 0 20px -5px hsl(var(--bitcoin) / 0.4)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'stacks-gradient': 'linear-gradient(135deg, #5546FF 0%, #7C6FFF 100%)',
        'bitcoin-gradient': 'linear-gradient(135deg, #F7931A 0%, #FFB347 100%)',
      },
    },
  },
  plugins: [],
